...
function_selectors = [
    ...
    lambda w: f"{w} is divisible by 5" if (w % 5) == 0 else "Not divisible by 5"      # Function to subtract 5 from the number
]
...
params = [
    (a, b),  # Parameters for the first lambda function (2 + 3)
...
print(result)  # Output should be (2 + 3) * 2 - 5 = 5
